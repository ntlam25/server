...
public class OrderService implements IOrderService {
    ...
    public OrderResponse createOrder(OrderRequest request) {
        ...
        for (CartItemDTO item : request.getItems()) {
            ...
            for (OptionChoiceDTO choice : choices) {
                System.out.println(choice.getOptionName() + choice.getOptionId());
    ...
    public List<OrderResponse> getCustomerOrdersUpcoming(Long customerId) {
        List<Order> upcoming = orderRepository.findOrdersByCustomerAndStatuses(customerId,
                List.of(
                        OrderStatus.PENDING,
    ...
    public List<OrderResponse> getCustomerOrdersHistory(Long customerId) {
        List<Order> history = orderRepository.findOrdersByCustomerAndStatuses(customerId,
                List.of(
    ...
    public OrderResponse updateOrderStatus(Long orderId, String status, Long customerId) {
        ...
        order.getStatusHistory().add(OrderStatusHistory.builder()
                ...
                .changedBy(customer)
                .notes("Cập nhật trạng thái đơn hàng thành " + status)
                .build());
        // Lưu vào database
